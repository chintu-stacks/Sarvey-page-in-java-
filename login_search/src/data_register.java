 ...
 * @author Chin2
 */
public class data_register extends javax.swing.JFrame {

    /**
     * Creates new form data_register
     */
        ...
        public static void main(String args[]) {
            ...
            */
            try {
                ...
                java.util.logging.Logger.getLogger(data_register.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new data_register().setVisible(true);
                }
            });
        }
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try
        {
            ...
            PreparedStatement pre=con.prepareStatement("insert into reg values(?,?,?,?,?,?)");
